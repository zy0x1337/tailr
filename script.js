...
// Pet Profile Creator Management
class PetProfileCreator {
    constructor() {
        this.currentStep = 1;
        this.totalSteps = 6; // Anpassen je nach Anzahl Ihrer Schritte
    ...
    nextStep() {
        if (this.currentStep < this.totalSteps) {
            ...
            document.querySelector(`.form-step:nth-child(${this.currentStep})`)?. 
    ...
    updateProgressBar() {
        // Progress Bar Breite aktualisieren
...
// Pet Profile Creator initialisieren
document.addEventListener('DOMContentLoaded', () => {
    new PetProfileCreator();
});
